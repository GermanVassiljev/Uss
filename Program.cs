...
namespace Uss_1
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Sounds background = new Sounds(settings.GetResourceFolder());
            background.Play(); //проигрывается начальная музыка
            Sounds eating = new Sounds(settings.GetResourceFolder());
            Sounds game_over = new Sounds(settings.GetResourceFolder());*/
            // Создание окна
